...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "International University of East Africa",
      logo: require("./assets/images/iuea logo.png"),
      subHeader: "Bachelor of Science in Computer Science",
      duration: "september 2020 - November 2023",
      desc: "Participated in the research of XXX and published 3 papers.",
      descBullets: [
        "Gained in-depth knowledge of software engineering principles and methodologies, including Agile and Scrum.",
        "Mastered web application development, focusing on both client-side and server-side scripting.",
        "Developed proficiency in programming languages such as Java, Python, and JavaScript for software development."
      ]
    },
    {
      schoolName: "Multitech Business School",
      logo: require("./assets/images/multitech-logo.jpeg"),
      subHeader: "Diploma in Business Administration , Business Administration and Management, General",
      duration: "September 2016 - Dec 2019",
      desc: "Ranked top 10% in the program. Took courses about Software Engineering, Web Security, Operating Systems, ...",
      descBullets: ["Studied marketing strategies and consumer behavior."]
    }
  ]
};
